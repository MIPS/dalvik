...
#ifndef _DALVIK_VM_COMPILER_CODEGEN_MIPS_CALLOUT_HELPER_H
#define _DALVIK_VM_COMPILER_CODEGEN_MIPS_CALLOUT_HELPER_H
...
#endif /* _DALVIK_VM_COMPILER_CODEGEN_MIPS_CALLOUT_HELPER_H */
