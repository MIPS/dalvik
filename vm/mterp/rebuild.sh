...
for arch in portstd portdbg allstubs armv4t armv5te armv5te-vfp armv7-a armv7-a-neon x86 x86-atom mips; do TARGET_ARCH_EXT=$arch make -f Makefile-mterp; done
